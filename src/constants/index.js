...
export const HERO_CONTENT = `I am a dedicated Data Engineer with expertise in data engineering, machine learning, and analytics. My experience includes developing a range of innovative products, such as analytics dashboards, diagnostic tools, and a voice intent builder, utilizing technologies like Java, Python, SQL, and AWS. I specialize in designing and implementing scalable data models and ETL/ELT pipelines for reporting and analytics, leveraging Python, SQL, and Apache Airflow. Additionally, I have strong skills in managing AWS Data & Analytics Infrastructure, driving operational efficiencies and minimizing post-deployment issues.`;
